...
const styles: Record<string, CSSProperties> = {
  page: {
    ...
    padding: '32px 20px',
    background:
      'radial-gradient(circle at top, rgba(194, 234, 255, 0.44), transparent 40%), linear-gradient(180deg, #f8fcff 0%, #ffffff 100%)',
  },
  card: {
    width: '100%',
    maxWidth: '560px',
    borderRadius: '28px',
    border: '1px solid rgba(68, 111, 140, 0.14)',
    background: 'rgba(255, 255, 255, 0.92)',
    boxShadow: '0 20px 50px rgba(63, 103, 130, 0.12)',
    padding: '32px',
    textAlign: 'left',
  ...
  button: {
    ...
    border: 'none',
    borderRadius: '14px',
    background: 'linear-gradient(135deg, #4d92b4, #23607c)',
    color: '#fff',
    padding: '14px 18px',
    fontSize: '1rem',
    fontWeight: 700,
